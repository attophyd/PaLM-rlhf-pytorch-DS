...
## PaLM + RLHF - Pytorch - DeepSpeed Setup (wip)


Instead of accelerate implementation, this fork creates modificated DeepSpeed training setup fork of <a href="https://github.com/lucidrains/PaLM-rlhf-pytorch">PaLM RLHF - PyTorch</a> by lucidrains. 
